...
struct __attribute__((packed)) port_registers_struct {
	...
	volatile uint32_t	afrh;		// Старший регистр настройки альтернативных функций выводов.
};
...
struct __attribute__((packed)) port_registers_flash_copy_struct {
	...
	uint32_t				afrh;			// Данные старший регистр настроек альтернативных функций выводов.
