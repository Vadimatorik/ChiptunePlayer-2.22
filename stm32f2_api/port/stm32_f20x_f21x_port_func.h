...
constexpr uint32_t pin_set_msk ( const pin_config_t *pin_cfg_array ) {
	return 1 << pin_cfg_array->pin_name;
}

// Маска установки выхода в "0".
constexpr uint32_t pin_reset_msk ( const pin_config_t *pin_cfg_array ) {
	return 1 << (pin_cfg_array->pin_name + 16);
}

// Указатель на bit_banding область памяти, в которой находится бит состояния входа.
constexpr uint32_t pin_bb_p_idr_read ( const pin_config_t *pin_cfg_array ) {
...
constexpr uint32_t pin_p_odr( const pin_config_t *pin_cfg_array ) {
	uint32_t p_port	= p_base_port_address_get(pin_cfg_array->port);		// Получаем физический адресс порта вывода.
...
constexpr uint32_t pin_odr_bit_read_bb_p ( const pin_config_t *pin_cfg_array ) {
	uint32_t p_port	= p_base_port_address_get(pin_cfg_array->port);		// Получаем физический адресс порта вывода.
...
constexpr uint32_t pin_bb_p_looking_bit ( const pin_config_t* pin_cfg_array ) {
	uint32_t p_port	= p_base_port_address_get(pin_cfg_array->port);		// Получаем физический адресс порта вывода.
 ...
 *****************************************************************************************************/
constexpr uint32_t global_port_moder_registr_reset_init_msk( enum_port_name port_name ) {
	switch(port_name){
...
// Режим работы.
constexpr uint32_t global_port_registr_moder_init_msk( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
// Режим выхода.
constexpr uint32_t global_port_registr_otyper_init_msk( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
// Скорость.
constexpr uint32_t global_port_registr_ospeeder_init_msk( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
// Подтяжка.
constexpr uint32_t global_port_registr_pupdr_init_msk( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
// Блокировка настроек.
constexpr uint32_t global_port_registr_lckr_init_msk( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
constexpr uint32_t global_port_registr_afrl_init_msk( const pin_config_t *pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
constexpr uint32_t global_port_registr_afrh_msk_init_get( const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
...
constexpr uint32_t global_port_registr_odr_msk_init_get(const pin_config_t *const pin_cfg_array, const uint32_t pin_count, const enum_port_name port_name) {
