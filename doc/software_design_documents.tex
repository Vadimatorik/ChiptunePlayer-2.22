...
\begin{itemize}
	...
	\item \textbf{module\_stm32f2\_low\_level\_by\_st} - низкоуровневая библиотека для работы с переферией микроконтроллера (реализует интерфейсы module\_mc\_hardware\_interfaces).
